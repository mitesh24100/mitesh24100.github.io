            ...
            <div class="gradient-cards">
                <div class="projects-card">
                    <div class="container-card bg-green-box">
                        <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <AutoStoriesIcon style={{ color: '#e25a61e6' }} />
                            <defs>
                        ...
                        <p class="card-title"><a href='https://github.com/mitesh24100/RAG-PDF-Assistant' style={{ color: 'white'}}>RAG PDF Assistant</a></p>
                        <p class="card-description"><span style={{ marginRight: '5px' }}>•</span> Built a local Retrieval-Augmented Generation (RAG) system using LangChain, ChromaDB, and Streamlit, enabling dynamic PDF ingestion, chunking, embedding, and real-time question answering without relying on external APIs</p>
                        <p class="card-description"><span style={{ marginRight: '5px' }}>•</span> Integrated Ollama-based LLMs and embedding models to deliver fully offline, privacy-preserving inference with efficient vector search and optimized text chunking strategies.</p>
                        <p class="card-description"><span style={{ marginRight: '5px' }}>•</span> Developed a robust interactive web interface supporting live PDF uploads, automatic vector database regeneration, and natural language query workflows.</p>
                    </div>
                </div>
                ...
                <div class="projects-card">
                    <div class="container-card bg-green-box">
                        ...
                        <p class="card-title">Custom Load Balancer in GoLang</p>
                        <p class="card-description"><span style={{ marginRight: '5px' }}>•</span> Developed a custom load balancer in Go that distributes HTTP requests across multiple backend servers using round-robin scheduling, improving scalability and fault tolerance.</p>
                        <p class="card-description"><span style={{ marginRight: '5px' }}>•</span> Implemented health checks and connection management to ensure high availability, automatically removing unresponsive servers from the pool.</p>
                        <p class="card-description"><span style={{ marginRight: '5px' }}>•</span> Leveraged Go’s concurrency model (goroutines & channels) to handle multiple client requests efficiently, achieving low-latency request routing under load.</p>
                    </div>
                </div>
                ...
                <div class="projects-card">
                    <div class="container-card bg-white-box">
                        ...
                        <p class="card-title"><a href='https://github.com/mitesh24100/nutriquest' style={{color: 'white'}}>NutriQuest</a></p>
                        <p class="card-description"><span style={{ marginRight: '5px' }}>•</span> Led the development of a cloud-hosted MERN application integrating Gemini LLM for barcode-based food recognition, enabling nutrition and sustainability analysis with 95% accuracy.</p>
                        <p class="card-description"><span style={{ marginRight: '5px' }}>•</span> Wrote backend services for food data storage, expiry tracking, and AI-driven recipe generation, reducing simulated food waste by 20% in pilot testing through timely alerts and meal planning.</p>
                    </div>
                </div>
                ...
                <div class="projects-card">
                    <div class="container-card bg-yellow-box">
                        ...
                        <p class="card-title"><a href='https://github.com/gef24-group/game-engine'style={{color: 'white'}}>MultiPlayer Game Engine</a></p>
                        <p class="card-description"><span style={{ marginRight: '5px' }}>•</span> Architected a custom 2D game engine in C++ with SDL3, featuring collision detection, a lightweight physics engine, and optimized rendering pipelines that reduced frame latency by 25%.</p>
                        <p class="card-description"><span style={{ marginRight: '5px' }}>•</span> Implemented multiplayer networking with ZeroMQ, supporting both peer-to-peer and client-server models for real-time synchronized gameplay across distributed clients.</p>
                    </div>
                </div>
            </div>
        </div>
